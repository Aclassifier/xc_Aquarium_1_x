        ...
        select {
            case tmr when timerafter(time) :> void: {
                ...
                if (raw_timer_interval_cntdown_seconds == 0) {
                    ...
                    if (temps_onetenthDegC[IOF_TEMPC_WATER] == 0) { // TODO I needed this for FLASHED version to avoid it starting off in REGULATING_AT_BOILING. Why?
                        debug_printf ("%s", "zero! ");
                ...
                } else {} // raw_timer_interval_cntdown_seconds not counted down yet
            } break;
