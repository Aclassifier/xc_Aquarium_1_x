...
#define GLOBALS_H_
    ...
    #define IS_LED_CONFIG_7 7 // Now in aquarium
        ...
        #define IS_LED_CONFIG IS_LED_CONFIG_6 // No LED jumpers (="out") on the old LED compartment at ØM11 office test site
    #elif (ISLED==IS_LED_CONFIG_7) // AQU=106 new
        #define IS_LED_CONFIG IS_LED_CONFIG_7 // All three LED jumpers in, present LED compartment at ØM11 aquarium
    #else
        #error
    #endif
