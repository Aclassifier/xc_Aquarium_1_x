...
#define GLOBALS_H_
    ...
    typedef unsigned beeper_blip_now_ms_t; // AQU=096 now just an unsigned
        ...
        #define IS_LED_CONFIG 6 // No LED jumpers (="out") on the old LED compartment at ØM11 office test site
    #elif (ISLED==7) // AQU=106 new
        #define IS_LED_CONFIG 7 // All three LED jumpers in, present LED compartment at ØM11 aquarium
    #else
        #error
    #endif
