...
#define RAW_TIMER_INTERVAL_MILLISECONDS         100 // Times 100 yields 10 seconds round trip when ON_OFF_PROPORTIONAL
#define RAW_HEATER_INTERVAL_IS_100_MILLISECONDS (RAW_TIMER_INTERVAL_MILLISECONDS * XS1_TIMER_KHZ)
#define NUM_TIMER_TICKS_PER_SECOND              10  // 10 seconds seem to give 0.2 degC some times. Try with 5
#define TEMP_MEASURE_INTERVAL_IS_10_SECONDS     ((NUM_TIMER_TICKS_PER_SECOND * 1000) / RAW_TIMER_INTERVAL_MILLISECONDS)
...
void temperature_heater_controller (
    ...
    while(1) {
        ...
        case tmr when timerafter(time) :> void: {
                time += RAW_HEATER_INTERVAL_IS_100_MILLISECONDS;
                ...
                if (is_doing == IS_READING_TEMPS) { // Code moved from notify:
