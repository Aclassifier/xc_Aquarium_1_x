...
#define APPLICATION_VERSION_STR "1.4.05" // Always use "X.Y.NN" since we introduced APPLICATION_VERSION_NUM:
#define APPLICATION_VERSION_NUM    1405  // Is "application_version_num_t"
    //  1.4.05     29Jan2019         SCREEN_8_RADIO changed, some other screen layout
    //  1.4.04     29Jan2019 AQU=069 pressed_for_10_seconds TODO remove the code as well, just commented out by now
