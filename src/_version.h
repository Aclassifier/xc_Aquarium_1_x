...
#define AQUARIUM_VERSION_STR "1.4.79" // Always use "X.Y.NN" since we introduced AQUARIUM_VERSION_NUM:
#define AQUARIUM_VERSION_NUM    1479  // Is "AQUARIUM_VERSION_NUM_t"
