...
#define APPLICATION_VERSION_STR "1.1.23" // Always use "X.Y.NN" since we introduced APPLICATION_VERSION_NUM:
#define APPLICATION_VERSION_NUM    1123  // Is "application_version_num_t"
    // "1.1.23"    01Oct2018 AQU=050 Possible to set day-time to 14, 12, 10 or 8 hours by menu.
