...
#define AQUARIUM_VERSION_STR "1.4.73" // Always use "X.Y.NN" since we introduced AQUARIUM_VERSION_NUM:
#define AQUARIUM_VERSION_NUM    1473  // Is "AQUARIUM_VERSION_NUM_t"
// 1.4.73     23May2019 AQU=079  Names only
