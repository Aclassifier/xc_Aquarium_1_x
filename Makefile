...
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_USER=2 
...
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_I_RADIO_ANY=0 # Cost some 750 bytes because unused entities are still linked
...
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_VALUE_XSCOPE=0
XCC_FLAGS += -D_USERMAKEFILE_VALUE_XSCOPE=0 # 0:60428 1:60444
XCC_FLAGS += -D_USERMAKEFILE_SPI_MASTER_POS=2 # 1 or 2
endif
