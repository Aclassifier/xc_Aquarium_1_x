...
# -02 is default
XCC_FLAGS = -Os -g -fxscope -save-temps -DMYTARGET=STARKIT -DISMASTER=1 -DWARNINGS=0 -D_USERMAKEFILE_LIB_RFM69_XC_USER=2 -D_USERMAKEFILE_LIB_RFM69_XC_PAYLOAD_LEN08=4 -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_PRINT_GLOBAL=0 -D_USERMAKEFILE_LIB_RFM69_XC_RADIO_IF_READALLREGS=0
