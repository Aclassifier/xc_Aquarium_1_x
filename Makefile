...
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_USER=2                   # 2
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_I_RADIO_ANY=0            # 0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_TRANS=0                  # 0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_TRANS_ASYNCH_WRAPPED=0   # 0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_SHARED_LOG_VALUE=1 # 1
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_FOREVER_LOOP=0     # 0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_VALUE_XSCOPE=0           # 0
XCC_FLAGS += -D_USERMAKEFILE_VALUE_XSCOPE=0                        # 0
XCC_FLAGS += -D_USERMAKEFILE_SPI_MASTER_POS=2                      # 2
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_STRETCH_IRQ=0            # 0
XCC_FLAGS += -D_USERMAKEFILE_USE_GUARD_ON_IRQ_UPDATE=0             # 0 
#                                                TEST_VECTOR_WORKS # A   
#                                                TEST_VECTOR_FAILS #                       
endif
