# 1 "/Users/teig/workspace/module_i2c_master/src/i2c-mm.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/teig/workspace/module_i2c_master/src/i2c-mm.xc" 2
...
# 9 "/Users/teig/workspace/module_i2c_master/src/i2c-mm.xc" 2
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.3.0/target/include/xclib.h" 1 3
# 35 "/Applications/XMOS_xTIMEcomposer_Community_14.3.0/target/include/xclib.h" 3
unsigned bitrev(unsigned x);
# 46 "/Applications/XMOS_xTIMEcomposer_Community_14.3.0/target/include/xclib.h" 3
unsigned byterev(unsigned x);
# 59 "/Applications/XMOS_xTIMEcomposer_Community_14.3.0/target/include/xclib.h" 3
int clz(unsigned x);
# 10 "/Users/teig/workspace/module_i2c_master/src/i2c-mm.xc" 2
...
# 11 "/Users/teig/workspace/module_i2c_master/src/i2c-mm.xc" 2
...
static int highPulse(struct r_i2c &i2c, int doSample) {
    ...
    waitQuarter(i2c);
    i2c.scl when __builtin_pins_eq(1) :> void;
    waitQuarter(i2c);
    if (doSample) {
        i2c.sda :> temp;
    }
...
static void startBit(struct r_i2c &i2c, int waitForQuiet) {
    if (waitForQuiet) {
        ...
        while(!done) {
            select {
            case i2c.sda when __builtin_pins_ne(sdaState) :> sdaState:
                t :> time;
                break;
            case i2c.scl when __builtin_pins_ne(sclState) :> sclState:
                t :> time;
                break;
            case sdaState && sclState => t when __builtin_timer_after(time+i2c.clockTicks) :> void:
                done = 1;
                break;
            }
        }
