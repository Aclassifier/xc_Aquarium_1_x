	...
	.set adc_task.select.y.enable.cases.nstackwords, 0 $M (adc_task.select.y.case.3.nstackwords) $M (adc_task.select.y.case.1.nstackwords) $M (adc_task.select.y.case.0.nstackwords) $M (adc_task.select.y.case.2.nstackwords)
