	...
	.set adc_task.select.yield.enable.cases.nstackwords, 0 $M (adc_task.select.yield.case.3.nstackwords) $M (adc_task.select.yield.case.0.nstackwords) $M (adc_task.select.yield.case.2.nstackwords) $M (adc_task.select.yield.case.1.nstackwords)
	...
	.set adc_task.select.enable.cases.nstackwords, 0 $M (adc_task.select.case.2.nstackwords) $M (adc_task.select.case.0.nstackwords) $M (adc_task.select.case.3.nstackwords) $M (adc_task.select.case.1.nstackwords)
