...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/string.h" 1 3



# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/string.h" 1 3
# 15 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/string.h" 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/clang/stddef.h" 1 3
# 16 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/string.h" 2 3
...
# 54 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/string.h" 3
...
char *strlwr (char *);
char *strupr (char *);
# 102 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/string.h" 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/sys/string.h" 1 3
# 103 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/string.h" 2 3

}
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/string.h" 2 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/safe/string.h" 1 3



# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/string.h" 1 3
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/safe/string.h" 2 3
...
# 6 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/string.h" 2 3
...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/errno.h" 1 3



# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/errno.h" 1 3
...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/sys/errno.h" 1 3
...
extern "C" {
# 16 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/sys/errno.h" 3
extern int *__errno (void);
# 57 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/sys/errno.h" 3
}
# 10 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/errno.h" 2 3
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/errno.h" 2 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/safe/errno.h" 1 3



# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/errno.h" 1 3
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/safe/errno.h" 2 3


int * alias _safe_errno_addr(void);
# 6 "/Applications/XMOS_xTIMEcomposer_Community_14.4.1/target/include/xc/errno.h" 2 3
...
uint16_t Tempchip_MCP9808_Read16 (struct r_i2c &i2c_external_config, i2c_master_params_t &i2c_external_params, uint8_t reg) {
    ...
    do { if((0==1) && (0==1)) printf("I2C:R %u %u\n", device, i2c_external_params._result); } while (0);
    ...
    do { if((0==1) && (0==1)) printf("Tempchip_MCP9808_Read16 res:%d dev:%02x reg:%d val:%04x\n", i2c_external_params._result, device, reg_addr, return_val); } while (0);
