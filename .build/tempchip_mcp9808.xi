...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/string.h" 1 3
# 15 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/string.h" 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/clang/stddef.h" 1 3
# 16 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/string.h" 2 3
...
# 54 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/string.h" 3
...
char *strlwr (char *);
char *strupr (char *);
# 102 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/string.h" 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/sys/string.h" 1 3
# 103 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/string.h" 2 3

}
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/string.h" 2 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/safe/string.h" 1 3



# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/string.h" 1 3
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/safe/string.h" 2 3
...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/errno.h" 1 3
...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/sys/errno.h" 1 3
...
extern "C" {
# 16 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/sys/errno.h" 3
extern int *__errno (void);
# 57 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/sys/errno.h" 3
}
# 10 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/errno.h" 2 3
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/errno.h" 2 3
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/safe/errno.h" 1 3



# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/errno.h" 1 3
# 5 "/Applications/XMOS_xTIMEcomposer_Community_14.2.4/target/include/xc/safe/errno.h" 2 3
...
bool Tempchip_MCP9808_Begin_Ok (struct r_i2c &i2c_external_config, i2c_master_params_t * i2c_external_params_ptr, uint8_t address) {

    uint16_t read_val;
    i2c_external_params_ptr->_use_dev_address = address;

    read_val = Tempchip_MCP9808_Read16(i2c_external_config, i2c_external_params_ptr, 0x06);
    if ((i2c_external_params_ptr->_result == I2C_OK) && (read_val == 0x0054)) {

        read_val = Tempchip_MCP9808_Read16(i2c_external_config, i2c_external_params_ptr, 0x07);
        if ((i2c_external_params_ptr->_result == I2C_OK) && (read_val == 0x0400)) {
            return true;
        } else {
            return false;
        }
...
i2c_temp_onetenthDegC_t Tempchip_MCP9808_ReadTempC (struct r_i2c &i2c_external_config, i2c_master_params_t * i2c_external_params_ptr, bool* ok_ptr) {
    ...
    uint16_t read_val = Tempchip_MCP9808_Read16(i2c_external_config, i2c_external_params_ptr, 0x05);
...
bool Tempchip_MCP9808_Shutdown_Wake_Ok (struct r_i2c &i2c_external_config, i2c_master_params_t * i2c_external_params_ptr, bool shutdown) {

    uint16_t conf_shutdown ;
    uint16_t conf_reg_address = Tempchip_MCP9808_Read16(i2c_external_config, i2c_external_params_ptr, 0x01);

    if (i2c_external_params_ptr->_result == I2C_OK) {
        if (shutdown)
        {
           conf_shutdown = conf_reg_address | 0x0100 ;
           Tempchip_MCP9808_Write16(i2c_external_config, i2c_external_params_ptr, 0x01, conf_shutdown);
        }
        else
        {
           conf_shutdown = conf_reg_address ^ 0x0100 ;
