	...
	.set startkit_gpio_driver_aux.select.yield.enable.cases.nstackwords, 0 $M (startkit_gpio_driver_aux.select.yield.case.2.nstackwords) $M (startkit_gpio_driver_aux.select.yield.case.3.nstackwords) $M (startkit_gpio_driver_aux.select.yield.case.4.nstackwords) $M (startkit_gpio_driver_aux.select.yield.case.0.nstackwords) $M (startkit_gpio_driver_aux.select.yield.case.1.nstackwords)
