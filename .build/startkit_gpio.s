	...
	.set startkit_gpio_driver_aux.select.enable.cases.nstackwords, 0 $M (startkit_gpio_driver_aux.select.case.2.nstackwords) $M (startkit_gpio_driver_aux.select.case.3.nstackwords) $M (startkit_gpio_driver_aux.select.case.4.nstackwords) $M (startkit_gpio_driver_aux.select.case.0.nstackwords) $M (startkit_gpio_driver_aux.select.case.1.nstackwords)
