...
outP_display_notReset.info:
	...
	.set usage.anon.8,0
	.set usage.anon.9,0
	.globread drawVerticalLineInternal_in_buffer,usage.anon.9,"../src/display_ssd1306.xc:508:33: note: object used here\n        register uint8_t mask = postmask[mod];\n                                ^~~~~~~~~~~~~"
	.globread drawVerticalLineInternal_in_buffer,usage.anon.8,"../src/display_ssd1306.xc:446:33: note: object used here\n        register uint8_t mask = premask[mod];\n                                ^~~~~~~~~~~~"
	.globread drawVerticalLineInternal_in_buffer,display_param,2,2,"../src/display_ssd1306.xc:416:24: note: object used here (bytes 2..4)\n    if ( (__y + __h) > display_param.HEIGHT) {\n                       ^~~~~~~~~~~~~~~~~~~~"
	.globread drawVerticalLineInternal_in_buffer,display_param,0,2,"../src/display_ssd1306.xc:406:23: note: object used here (bytes 0..2)\n    if (x < 0 || x >= display_param.WIDTH) { return; }\n                      ^~~~~~~~~~~~~~~~~~~"
	.globread drawVerticalLine_in_buffer,display_param,17,1,"../src/display_ssd1306.xc:372:13: note: object used here (bytes 17..18)\n    switch (display_param.rotation) {\n            ^~~~~~~~~~~~~~~~~~~~~~"
	.globread drawVerticalLine_in_buffer,display_param,2,2,"../src/display_ssd1306.xc:385:17: note: object used here (bytes 2..4)\n            y = display_param.HEIGHT - y - 1;\n                ^~~~~~~~~~~~~~~~~~~~"
	.globread drawVerticalLine_in_buffer,display_param,0,2,"../src/display_ssd1306.xc:379:17: note: object used here (bytes 0..2)\n            x = display_param.WIDTH - x - 1;\n                ^~~~~~~~~~~~~~~~~~~"
	.globread drawHorisontalLineInternal_in_buffer,display_param,2,2,"../src/display_ssd1306.xc:337:23: note: object used here (bytes 2..4)\n    if (y < 0 || y >= display_param.HEIGHT) { return; }\n                      ^~~~~~~~~~~~~~~~~~~~"
	.globread drawHorisontalLineInternal_in_buffer,display_param,0,2,"../src/display_ssd1306.xc:346:19: note: object used here (bytes 0..2)\n    if ((x + w) > display_param.WIDTH) {\n                  ^~~~~~~~~~~~~~~~~~~"
	...
	.globread fillSplashScreen_in_buffer,usage.anon.7,"../src/display_ssd1306.xc:297:21: note: object used here\n    memcpy (buffer, splash_buffer, SSD1306_BUFFER_SIZE);\n                    ^~~~~~~~~~~~~\n/Applications/XMOS_xTIMEcomposer_Community_14.3.1/target/include/xc/string.h:14:44: note: expanded from macro \'memcpy\'\n#define memcpy(s1, s2, n) _safe_memcpy(s1, s2, n)\n                                           ^\n/Applications/XMOS_xTIMEcomposer_Community_14.3.1/target/include/xc/safe/string.h:11:57: note: expanded from macro \'_safe_memcpy\'\n#define _safe_memcpy(s1, s2, n) __builtin_memcpy_xc(s1, s2, n)\n                                                        ^"
	.globread fillSplashScreen_in_buffer,usage.anon.6,"../src/display_ssd1306.xc:297:13: note: object used here\n    memcpy (buffer, splash_buffer, SSD1306_BUFFER_SIZE);\n            ^~~~~~\n/Applications/XMOS_xTIMEcomposer_Community_14.3.1/target/include/xc/string.h:14:40: note: expanded from macro \'memcpy\'\n#define memcpy(s1, s2, n) _safe_memcpy(s1, s2, n)\n                                       ^\n/Applications/XMOS_xTIMEcomposer_Community_14.3.1/target/include/xc/safe/string.h:11:53: note: expanded from macro \'_safe_memcpy\'\n#define _safe_memcpy(s1, s2, n) __builtin_memcpy_xc(s1, s2, n)\n                                                    ^"
...
.Ltmp0:
	.size	_i.i2c_internal_commands_if._chan.write_byte_fram_ok, .Ltmp0-_i.i2c_internal_commands_if._chan.write_byte_fram_ok
	.cfi_endproc
...
.Ltmp1:
	.size	_i.i2c_internal_commands_if._chan.read_byte_fram_ok, .Ltmp1-_i.i2c_internal_commands_if._chan.read_byte_fram_ok
	.cfi_endproc
...
.Ltmp9:
	.size	_i.i2c_internal_commands_if._chan.write_chronodot_ok, .Ltmp9-_i.i2c_internal_commands_if._chan.write_chronodot_ok
	.cfi_endproc
...
.Ltmp17:
	.size	_i.i2c_internal_commands_if._chan.read_chronodot_ok, .Ltmp17-_i.i2c_internal_commands_if._chan.read_chronodot_ok
	.cfi_endproc
...
.Ltmp22:
	.size	_i.i2c_internal_commands_if._chan.write_display_ok, .Ltmp22-_i.i2c_internal_commands_if._chan.write_display_ok
	.cfi_endproc
...
.Ltmp26:
	.size	_i.i2c_internal_commands_if._chan_yield.write_byte_fram_ok, .Ltmp26-_i.i2c_internal_commands_if._chan_yield.write_byte_fram_ok
	.cfi_endproc
...
.Ltmp30:
	.size	_i.i2c_internal_commands_if._chan_yield.read_byte_fram_ok, .Ltmp30-_i.i2c_internal_commands_if._chan_yield.read_byte_fram_ok
	.cfi_endproc
...
.Ltmp38:
	.size	_i.i2c_internal_commands_if._chan_yield.write_chronodot_ok, .Ltmp38-_i.i2c_internal_commands_if._chan_yield.write_chronodot_ok
	.cfi_endproc
...
.Ltmp46:
	.size	_i.i2c_internal_commands_if._chan_yield.read_chronodot_ok, .Ltmp46-_i.i2c_internal_commands_if._chan_yield.read_chronodot_ok
	.cfi_endproc
...
.Ltmp52:
	.size	_i.i2c_internal_commands_if._chan_yield.write_display_ok, .Ltmp52-_i.i2c_internal_commands_if._chan_yield.write_display_ok
	.cfi_endproc
...
.Ltmp80:
	.size	setPixel_in_buffer, .Ltmp80-setPixel_in_buffer
.Lfunc_end10:
	.cfi_endproc
...
.Ltmp156:
	.size	Adafruit_SSD1306_i2c_begin, .Ltmp156-Adafruit_SSD1306_i2c_begin
.Lfunc_end11:
	.cfi_endproc
...
.Ltmp165:
	.size	writeDisplay_i2c_command, .Ltmp165-writeDisplay_i2c_command
.Lfunc_end12:
	.cfi_endproc
...
.Ltmp174:
	.size	writeDisplay_i2c_data, .Ltmp174-writeDisplay_i2c_data
.Lfunc_end13:
	.cfi_endproc
...
.Ltmp185:
	.size	tellDisplay_i2c_invert, .Ltmp185-tellDisplay_i2c_invert
.Lfunc_end14:
	.cfi_endproc
...
.Ltmp228:
	.size	tellDisplay_i2c_startscrollright, .Ltmp228-tellDisplay_i2c_startscrollright
.Lfunc_end15:
	.cfi_endproc
...
.Ltmp271:
	.size	tellDisplay_i2c_startscrollleft, .Ltmp271-tellDisplay_i2c_startscrollleft
.Lfunc_end16:
	.cfi_endproc
...
.Ltmp320:
	.size	tellDisplay_i2c_startscrolldiagright, .Ltmp320-tellDisplay_i2c_startscrolldiagright
.Lfunc_end17:
	.cfi_endproc
...
.Ltmp369:
	.size	tellDisplay_i2c_startscrolldiagleft, .Ltmp369-tellDisplay_i2c_startscrolldiagleft
.Lfunc_end18:
	.cfi_endproc
...
.Ltmp379:
	.size	tellDisplay_i2c_stopscroll, .Ltmp379-tellDisplay_i2c_stopscroll
.Lfunc_end19:
	.cfi_endproc
...
.Ltmp422:
	.size	writeToDisplay_i2c_all_buffer, .Ltmp422-writeToDisplay_i2c_all_buffer
.Lfunc_end20:
	.cfi_endproc
...
.Ltmp427:
	.size	Clear_All_Pixels_In_Buffer, .Ltmp427-Clear_All_Pixels_In_Buffer
.Lfunc_end21:
	.cfi_endproc
...
.Ltmp432:
	.size	fillSplashScreen_in_buffer, .Ltmp432-fillSplashScreen_in_buffer
.Lfunc_end22:
	.cfi_endproc
...
.Ltmp448:
	.size	drawVerticalLine_in_buffer, .Ltmp448-drawVerticalLine_in_buffer
.Lfunc_end23:
	.cfi_endproc
...
.Ltmp464:
	.size	drawHorisontalLine_in_buffer, .Ltmp464-drawHorisontalLine_in_buffer
.Lfunc_end24:
	.cfi_endproc
...
.Ltmp512:
	.size	drawVerticalLineInternal_in_buffer, .Ltmp512-drawVerticalLineInternal_in_buffer
.Lfunc_end25:
	.cfi_endproc
...
.Ltmp536:
	.size	drawHorisontalLineInternal_in_buffer, .Ltmp536-drawHorisontalLineInternal_in_buffer
.Lfunc_end26:
	.cfi_endproc
...
.cc_top cc_78,.Lxta.call_labels2
	.ascii	"/Applications/XMOS_xTIMEcomposer_Community_14.3.1/target/include/timer.h"
	.byte	0
	.long	55
...
.cc_top cc_546,.Lxtalabel30
	.ascii	"/Applications/XMOS_xTIMEcomposer_Community_14.3.1/target/include/xc/safe/string.h"
	.byte	0
	.long	19
	.long	19
	.long	.Lxtalabel30
...
.cc_bottom cc_trapinfo_1
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str2:
.asciiz"../src/display_ssd1306.xc:144:27: error: out of bounds array access\n            case INVERSE: buffer[x + (y/8)*SSD1306_LCDWIDTH] ^=  (1 << (y&7)); break;\n                          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_2
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str3:
.asciiz"../src/display_ssd1306.xc:280:13: error: out of bounds array access\n            data[x] = buffer[i];\n            ^~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_3
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str4:
.asciiz"../src/display_ssd1306.xc:280:23: error: out of bounds array access\n            data[x] = buffer[i];\n                      ^~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_4
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str5:
.asciiz"../src/display_ssd1306.xc:446:33: error: out of bounds array access\n        register uint8_t mask = premask[mod];\n                                ^~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_7
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str8:
.asciiz"../src/display_ssd1306.xc:457:27: error: out of bounds array or pointer access\n            case INVERSE: *pBuf ^=  mask;  break;\n                          ^~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_8
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str9:
.asciiz"../src/display_ssd1306.xc:474:18: error: out of bounds array or pointer access\n                 *pBuf=~(*pBuf);\n                 ^~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_9
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str10:
.asciiz"../src/display_ssd1306.xc:489:17: error: out of bounds array or pointer access\n                *pBuf = val;\n                ^~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_10
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str11:
.asciiz"../src/display_ssd1306.xc:513:27: error: out of bounds array or pointer access\n            case INVERSE: *pBuf ^=  mask;  break;\n                          ^~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_14
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str15:
.asciiz"../src/display_ssd1306.xc:366:49: error: out of bounds array or pointer access\n        case INVERSE:             while (w--) { *pBuf++ ^= mask; }; break;\n                                                ^~~~~~~\n"
	.section	.trap_info,"",@progbits
