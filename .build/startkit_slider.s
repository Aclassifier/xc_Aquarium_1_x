	...
	.set slider_periodic.select.y.enable.cases.nstackwords, 0 $M (slider_periodic.select.y.case.0.nstackwords) $M (slider_periodic.select.y.case.1.nstackwords)
...
.Ltmp10:
	.size	_i.slider_if._chan_y.get_coord, .Ltmp10-_i.slider_if._chan_y.get_coord
	.cfi_endproc
...
.Ltmp14:
	.size	_i.slider_if._chan_y.get_slider_state, .Ltmp14-_i.slider_if._chan_y.get_slider_state
	.cfi_endproc
...
.Ltmp19:
	.size	_i.absolute_slider_if._chan_y.get_coord, .Ltmp19-_i.absolute_slider_if._chan_y.get_coord
	.cfi_endproc
...
.Ltmp25:
	.size	_i.slider_query_if._chan_y.get_coord, .Ltmp25-_i.slider_query_if._chan_y.get_coord
	.cfi_endproc
...
.Ltmp29:
	.size	_i.slider_query_if._chan_y.filter, .Ltmp29-_i.slider_query_if._chan_y.filter
	.cfi_endproc
...
.LBB12_1:
	...
	.set	slider_task.nstackwords,((((((absolute_slider.init.0.savedstate << 2) + 4) >> 2) + (((slider.init.0.savedstate << 2) + 4) >> 2)) + ((5 + absolute_slider.init.0.nstackwords) $M (1 + slider.init.0.nstackwords) $M (1 + slider_periodic.init.0.nstackwords) $M (1 + absolute_slider.init.1.nstackwords) $M (1 + slider.init.1.nstackwords) $M (1 + slider_periodic.init.1.nstackwords) $M (1 + absolute_slider.select.enable.nstackwords) $M (1 + slider.select.enable.nstackwords) $M (1 + slider_periodic.select.enable.nstackwords) $M slider_periodic.select.enable.cases.nstackwords $M absolute_slider.select.enable.cases.nstackwords $M slider.select.enable.cases.nstackwords)) + 28)
