...
void Button_Task (
    ...
    do { if((0==1) && (0==1)) printf("inP_Button_Task[%u] started\n", button_n); } while (0);
    ...
    while(1) {
        select {
            ...
            case is_stable => p_button when __builtin_pins_ne(current_val) :> current_val: {
                if (current_val == 0) {
                    do { if((0==1) && (0==1)) printf(": Button %u pressed\n", button_n); } while (0);
                } else {
                    do { if((0==1) && (0==1)) printf(": Button %u released\n", button_n); } while (0);
                }
                ...
                if (is_stable == false) {
                    if (current_val == 0) {
                        ...
                        if (initial_released_stopped == false) {
                            ...
                            do { if((0==1) && (0==1)) printf(" BUTTON_ACTION_RELEASED %u sent\n", button_n); } while (0);
                        }
                    }
                    is_stable = true;
                } else {
                    ...
                    do { if((0==1) && (0==1)) printf(" BUTTON_ACTION_PRESSED_FOR_10_SECONDS %u sent\n", button_n); } while (0);
                }
            } break;
