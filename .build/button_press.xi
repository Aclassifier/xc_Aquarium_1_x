...
void Button_Task (
    ...
    do { if(0 && (1==1)) printf("inP_Button_Task[%u] started\n", button_n); } while (0);
    ...
    while(1) {
        select {
            ...
            case is_stable => p_button when __builtin_pins_ne(current_val) :> current_val: {
                if (current_val == 0) {
                    do { if(0 && (1==1)) printf(": Button %u pressed\n", button_n); } while (0);
                } else {
                    do { if(0 && (1==1)) printf(": Button %u released\n", button_n); } while (0);
                }
            ...
            case (pressed_but_not_released || (is_stable == false)) => tmr when __builtin_timer_after(timeout) :> void: {
                if (is_stable == false) {
                    if (current_val == 0) {
                        ...
                        do { if(0 && (1==1)) printf(" BUTTON_ACTION_PRESSED %u sent\n", button_n); } while (0);
                        tmr :> current_time;
                        ...
                        if (initial_released_stopped == false) {
                            initial_released_stopped = true;
                            do { if(0 && (1==1)) printf(" Button %u filtered away\n", button_n); } while (0);
                        } else {
                            pressed_but_not_released = false;
                            i_button_out.button (BUTTON_ACTION_RELEASED);
                            do { if(0 && (1==1)) printf(" BUTTON_ACTION_RELEASED %u sent\n", button_n); } while (0);
                        }
                    }
                    is_stable = true;
                } else {
                    ...
                    do { if(0 && (1==1)) printf(" BUTTON_ACTION_PRESSED_FOR_10_SECONDS %u sent\n", button_n); } while (0);
                }
            } break;
