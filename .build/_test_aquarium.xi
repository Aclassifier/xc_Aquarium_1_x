# 1 "../src/_test_aquarium.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/_test_aquarium.xc" 2
# 10 "../src/_test_aquarium.xc"
...
int adafruit_display_ssd1306_128x32_i2c (
    ...
    int delay_ms;
    char these_3p3Norwegian[6] = {146, 236, 143, 145, 148, 132};
    ...
    switch (test_params_ptr->test_this_case) {
        case (-5): {
            ...
            if (test_params_ptr->test_this_screen_num == 1) {
                ...
                {rr_24V_voltage_onetenthV, rr_24_voltage_ok} = RR_12V_24V_to_string_ok (test_params_ptr->test_adc_vals_for_use[0], rr_24V_str);
                ...
                for (unsigned index=0; index<(21 * 4); index++) {
                ...
                setTextSize(2);
                setCursor(109,14);
                display_print (now_regulating_at_char[now_regulating_at],2);
                setTextSize(1);
...
# 177 "../src/_test_aquarium.xc"
            ...
            display_print (display_ts1_chars, (21*4));
            ...
            if (test_params_ptr->test_this_screen_num != 4) {
                ...
                writeDisplay_i2c_command(i_i2c_internal_commands, 0x81);
                writeDisplay_i2c_command(i_i2c_internal_commands, 0x00);
            }
        ...
        case (-4): {
            ...
            char display_ts1_chars [(21 * 4)];
            char degC_cirle[] = {247,0};
            int sprintf_return;

            i_port_heat_light_commands.light_command (LIGHT_COMPOSITION_3000_BACK1_CENTER1_FRONT1_ON);


            TC1047_raw_degC_to_string_ok (test_params_ptr->test_adc_vals_for_use[2], temp_degC_str);
            RR_12V_24V_to_string_ok (test_params_ptr->test_adc_vals_for_use[3], rr_12V_str);
            RR_12V_24V_to_string_ok (test_params_ptr->test_adc_vals_for_use[0], rr_24V_str);
            ambient_light_sensor_ALS_PDIC243_to_string_ok (test_params_ptr->test_adc_vals_for_use[1], lux_str);
        ...
        case (-3): {
            ...
            char compile_date[21];
            sprintf (compile_date,"%s %s","Feb 11 2017","11:41:34");
            clear_all_pixels_in_buffer();
            setTextSize(1);
            setTextColor(1);
            setCursor(0,0);
        ...
        case 1: {
            ...
            setCursor(0,0);
            {
                ...
                if (test_params_ptr->iof_light_composition >= LIGHT_COMPOSITION_6000_BACK2_CENTER2_FRONT2_ON) {
                    ...
                    display_print (info_chars, 7);
                } else {
                    sprintf (info_chars,"LYS=%02u",test_params_ptr->iof_light_composition);
                    display_print (info_chars, 6);
                }
            }
            writeToDisplay_i2c_all_buffer(i_i2c_internal_commands);

            test_params_ptr->iof_light_composition++;
            if (test_params_ptr->iof_light_composition == 13) {
                test_params_ptr->test_this_case = 2;
            }
            else {}
            break; }
        case 2: {
            for (light_composition_t iof_light_composition=0; iof_light_composition < 9; iof_light_composition++) {
                clear_all_pixels_in_buffer();
                setTextSize(2);
                setTextColor(1);
                setCursor(0,0);
        ...
        case 3: {
            ...
            unsigned int iof_light_composition_set [4] = {
            ...
            break; }
        case 4: {
            for (light_composition_t iof_light_composition=0; iof_light_composition < 13; iof_light_composition++) {
                clear_all_pixels_in_buffer();
                setTextSize(2);
                setTextColor(1);
                setCursor(0,0);
