...
.sameresource __xcc1_internal_2, i2c_external_config, 4
	...
	.assert 1,tempchip_mcp9808_readTempC.actnonotificationselect,"../src/i2c_external_server.xc:79:78: error: call to function `tempchip_mcp9808_readTempC\' which selects on a notification in a combinable function select case\n                        i2c_temps.i2c_temp_onetenthDegC[IOF_TEMPC_WATER]   = tempchip_mcp9808_readTempC (i2c_external_config, &i2c_external_params, &i2c_temps.i2c_temp_ok[IOF_TEMPC_WATER]);\n                                                                             ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	...
	.globpassesref tempchip_mcp9808_readTempC, i2c_external_config,"../src/i2c_external_server.xc:76:78: error: call to `tempchip_mcp9808_readTempC\' in `i2c_external_server\' makes alias of global \'i2c_external_config\'\n                        i2c_temps.i2c_temp_onetenthDegC[IOF_TEMPC_AMBIENT] = tempchip_mcp9808_readTempC (i2c_external_config, &i2c_external_params, &i2c_temps.i2c_temp_ok[IOF_TEMPC_AMBIENT]);\n                                                                             ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	.globpassesref tempchip_mcp9808_readTempC, i2c_external_config,"../src/i2c_external_server.xc:73:78: error: call to `tempchip_mcp9808_readTempC\' in `i2c_external_server\' makes alias of global \'i2c_external_config\'\n                        i2c_temps.i2c_temp_onetenthDegC[IOF_TEMPC_HEATER]  = tempchip_mcp9808_readTempC (i2c_external_config, &i2c_external_params, &i2c_temps.i2c_temp_ok[IOF_TEMPC_HEATER]);\n                                                                             ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
.Ltmp86:
	...
	.set	i2c_external_server.maxcores,i2c_master_init.maxcores $M sout_char_array.maxcores $M tempchip_mcp9808_begin_ok.maxcores $M tempchip_mcp9808_readTempC.maxcores $M 1
	.globl	i2c_external_server.maxcores
	.set	i2c_external_server.maxtimers,i2c_master_init.maxtimers $M sout_char_array.maxtimers $M tempchip_mcp9808_begin_ok.maxtimers $M tempchip_mcp9808_readTempC.maxtimers $M 0
	.globl	i2c_external_server.maxtimers
	.set	i2c_external_server.maxchanends,i2c_master_init.maxchanends $M sout_char_array.maxchanends $M tempchip_mcp9808_begin_ok.maxchanends $M tempchip_mcp9808_readTempC.maxchanends $M 0
...
.Ltrap_info_str0:
.asciiz"../src/i2c_external_server.xc:90:17: error: out of bounds array access\n                i_i2c_external_commands[index_of_client].notify();\n                ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
