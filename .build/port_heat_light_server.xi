...
# 80 "../src/port_heat_light_server.xc"
unsigned int p32_bits_for_light_light_composition_pwm_windows [13][3] =
{
...
# 163 "../src/port_heat_light_server.xc"
[[combinable]]
void port_heat_light_server (server port_heat_light_commands_if i_port_heat_light_commands[2]) {
    ...
    while (1) {
        select {
            ...
            case i_port_heat_light_commands[int index_of_client].light_command (const light_composition_t iof_light_composition_level): {
                present_iof_light_composition_level = iof_light_composition_level;
            } break;
