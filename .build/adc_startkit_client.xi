# 1 "../src/adc_startkit_client.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/adc_startkit_client.xc" 2
...
# 9 "../src/adc_startkit_client.xc" 2
...
# 11 "../src/adc_startkit_client.xc" 2
...
# 12 "../src/adc_startkit_client.xc" 2
...
# 15 "../src/adc_startkit_client.xc" 2
...
# 16 "../src/adc_startkit_client.xc" 2
# 1 "../src/param.h" 1
# 18 "../src/param.h"
...
# 17 "../src/adc_startkit_client.xc" 2
...
# 18 "../src/adc_startkit_client.xc" 2

typedef struct tag_startkit_adc_user_vals {
    unsigned short x[4];
    unsigned int mean_sum[4];
